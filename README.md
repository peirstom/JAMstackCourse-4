...
```bash
git clone https://github.com/peirstom/JAMstackCourse-4
```
...
- [Example 4 - Generating pages from a content API](https://github.com/peirstom/JAMstackCourse-4) (👈 you are here)
